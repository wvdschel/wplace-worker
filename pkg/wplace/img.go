...
var ColorPallette []color.Color = []color.Color{
	...
	ConvertColor("#000000ff"),
	ConvertColor("#3c3c3cff"),
	ConvertColor("#787878ff"),
	ConvertColor("#d2d2d2ff"),
	ConvertColor("#ffffffff"),
	ConvertColor("#600018ff"),
	ConvertColor("#ed1c24ff"),
	ConvertColor("#ff7f27ff"),
	ConvertColor("#f6aa09ff"),
	ConvertColor("#f9dd3bff"),
	ConvertColor("#fffabcff"),
	ConvertColor("#0eb968ff"),
	ConvertColor("#13e67bff"),
	ConvertColor("#87ff5eff"),
	ConvertColor("#0c816eff"),
	ConvertColor("#10aea6ff"),
	ConvertColor("#13e1beff"),
	ConvertColor("#28509eff"),
	ConvertColor("#4093e4ff"),
	ConvertColor("#60f7f2ff"),
	ConvertColor("#6b50f6ff"),
	ConvertColor("#99b1fbff"),
	ConvertColor("#780c99ff"),
	ConvertColor("#aa38b9ff"),
	ConvertColor("#e09ff9ff"),
	ConvertColor("#cb007aff"),
	ConvertColor("#ec1f80ff"),
	ConvertColor("#f38da9ff"),
	ConvertColor("#684634ff"),
	ConvertColor("#95682aff"),
	ConvertColor("#f8b277ff"),
}
